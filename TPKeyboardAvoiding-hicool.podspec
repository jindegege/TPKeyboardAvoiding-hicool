#
#  Be sure to run `pod spec lint TPKeyboardAvoiding-hicool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jindegege/TPKeyboardAvoiding-hicool"
  ...
  s.source       = { :git => "https://github.com/jindegege/TPKeyboardAvoiding-hicool.git", :tag => s.version }
